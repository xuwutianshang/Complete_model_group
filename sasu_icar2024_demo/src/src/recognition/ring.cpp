...
public:
    ...
    bool process(Tracking &track, Mat &imagePath)
    {
        ...
        cout << "countWide:" << countWide << endl;
            ...
            if ((ringStep == RingStep::None || ringStep == RingStep::Entering) && countWide >= 5 && !track.spurroad.empty()) {
              cout << "ruhuanType:" << ringTypeTemp << endl;
        ...
        if (ringStep == RingStep::Inside)
        {
            ...
            { cout << "chuhuan\n";
                ...
                } else if (1) // track.pointsEdgeRight.size() - rowBreakRight >
                              // 20)
                              // 
                              // else if (track.pointsEdgeRight.size() -
                              // rowBreakRight > 20)
                {
                ...
                else if (0) // track.pointsEdgeRight.size() - rowBreakRight <= 20)
    ...
    void drawImage(Tracking track, Mat &ringImage)
    {
        ...
        putText(ringImage, "[7] RING - ENABLE", Point(COLSIMAGE / 2 - 5, 20), cv::FONT_HERSHEY_TRIPLEX, 0.5, cv::Scalar(0, 255, 0), 1, CV_AA);
